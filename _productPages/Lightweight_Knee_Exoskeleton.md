...
![]({{ site.url }}{{ site.baseurl }}/images/productImages/Lightweight_Knee_Exoskeleton_Senor_And_Control_Description.png){: style="width: 80%; border: 10px"}
...
![]({{ site.url }}{{ site.baseurl }}/images/productImages/Lightweight_Knee_Exoskeleton_Portable_Exoskeleton Architecture (Teensy 3.6).png){: style="width: 80%; border: 10px"}
